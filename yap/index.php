...
if (isset($_POST["sub1"]) || isset($_POST["sub2"])     || isset($_POST["sub3"])) {
  ...
  $msg = "";
  $valid_image_check = array("image/gif", "image/jpeg", "image/jpg", "image/png", "image/bmp","image/mov","image/wmv");
            ...
            <form name="f1" action="index.php" method="post" enctype="multipart/form-data">            
              <fieldset>
				...
				<div class="container">
				 ...
				 <div class = "form-group">
					 <form name="f2" action="index1.php" method="post" enctype="multipart/form-data">
